...
int main(int argc, char **argv)
{
    ...
    if (strcmp(argv[1u], "-h") == 0)
    {
        ...
        std::cout << "Parameter 3: Output diagram width in characters." << std::endl;
        std::cout << "Parameter 4: Output diagram height in characters." << std::endl;
    ...
    {
        std::cout << "Plotting an IDEF diagram (use -h for more info)." << std::endl;
        ...
        Diagram.clear(); 
        delete Router;
        std::cout << "Done plotting. Output '" << OutputFilePath << "'." << std::endl; 
    }
